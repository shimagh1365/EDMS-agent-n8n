...
async function getUserDirectoryData() {
  const rows = await getSheetData(USER_DIRECTORY_SHEET_ID, "Sheet1!A1:F"); // ✅ correct tab
...
app.action("info_selected", async ({ ack, body, say }) => {
  ...
  // Store generated text for later "YES" click
  u.generatedDocument = aiDocument;

  // ✅ Display AI-generated document in chunks
